<!--Test Oracle file for UBC CPSC304 2018 Winter Term 1
  ...
  Insert values, and then query for values
  ...
  <html>
    ...
    <body>
        ...
        <p>The values are case sensitive and if you enter in the wrong case, the Insert statement will not do anything.</p>
        ...
        function handleInsertRequest() {
            ...
            executePlainSQL(" DELETE FROM Driver WHERE DriverID ='" . $old_name . "'");
