...
$stmt = "SELECT max(RatingRegion.avgRating) FROM (SELECT avgRating = AVG(rating) FROM drivers GROUP BY region) RatingRegion";
$rows=array();
...
<div class="container">
    <h2> Drivers' Region with the Highest Drive Rating
